...
# This state uses the registry to disable write access to tape drives
# on Windows machines.
Disable_write_access_tape_drives_registry:
  ...
  reg.present:
    - name: HKLM\Software\Policies\Microsoft\Windows\RemovableStorageDevices\{53f5630b-b6bf-11d0-94f2-00a0c91efb8b}
    - vname: Deny_Write
    - vtype: REG_DWORD
    - vdata: 1
