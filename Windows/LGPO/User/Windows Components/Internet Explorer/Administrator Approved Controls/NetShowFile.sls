...
#
####### LGPO DETAILS ########
# LOCATION: \User\Windows Components\Internet Explorer\Administrator Approved Controls\NetShowFile.sls
#
# SUPPORTED WINDOWS OS
# SUPPORTED_IE5
#
# Designates NetShow File Transfer Control as an administrator approved control.
# 
...
NetShow File Transfer Control:
  ...
  - name: NetShowFile
  - setting:
      NetShowFile: boolean-placeholder
  - policy_class: User
