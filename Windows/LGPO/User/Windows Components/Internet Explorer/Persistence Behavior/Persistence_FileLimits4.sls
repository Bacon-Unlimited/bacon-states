...
#
####### LGPO DETAILS ########
# LOCATION: \User\Windows Components\Internet Explorer\Persistence Behavior\Persistence_FileLimits4.sls
#
...
File size limits for Restricted Sites zone:
  lgpo.set:
  - name: Persistence_FileLimits4
  - setting:
      FileLimits_Document4: decimal-placeholder
      FileLimits_Domain4: decimal-placeholder
  - policy_class: User
