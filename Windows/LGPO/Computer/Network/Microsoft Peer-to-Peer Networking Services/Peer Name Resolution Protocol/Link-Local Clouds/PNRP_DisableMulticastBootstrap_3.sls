...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Network\Microsoft Peer-to-Peer Networking Services\Peer Name Resolution Protocol\Link-Local Clouds\PNRP_DisableMulticastBootstrap_3.sls
#
...
Turn off Multicast Bootstrap:
  lgpo.set:
  - name: PNRP_DisableMulticastBootstrap_3
  - setting: Enabled
