...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Network\Network Connections\Windows Defender Firewall\Domain Profile\WF_AllowedProgramsLocal_Name_1.sls
#
...
'Windows Defender Firewall: Allow local program exceptions':
  lgpo.set:
  - name: WF_AllowedProgramsLocal_Name_1
  - setting: Enabled
