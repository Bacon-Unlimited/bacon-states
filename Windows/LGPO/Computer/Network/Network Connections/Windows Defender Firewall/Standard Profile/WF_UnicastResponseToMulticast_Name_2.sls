...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Network\Network Connections\Windows Defender Firewall\Standard Profile\WF_UnicastResponseToMulticast_Name_2.sls
#
...
'Windows Defender Firewall: Prohibit unicast response to multicast or broadcast requests':
  lgpo.set:
  - name: WF_UnicastResponseToMulticast_Name_2
  - setting: Enabled
