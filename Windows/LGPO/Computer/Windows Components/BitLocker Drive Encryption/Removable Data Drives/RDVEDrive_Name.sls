...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\BitLocker Drive Encryption\Removable Data Drives\RDVEDrive_Name.sls
#
# SUPPORTED WINDOWS OS
# SUPPORTED_Windows8NoARM
#
# This policy setting allows you to manage BitLockers use of hardware-based encryption on removable data drives and specify which encryption algorithms it can use with hardware-based encryption. Using hardware-based encryption can improve performance of drive operations that involve frequent reading or writing of data to the drive.
# 
...
Configure use of hardware-based encryption for removable data drives:
  ...
  - name: RDVEDrive_Name
  - setting:
      RDVAllowedAlgos: text-placeholder
      RDVRestrictAlgos: boolean-placeholder
      RDVUseSW: boolean-placeholder
