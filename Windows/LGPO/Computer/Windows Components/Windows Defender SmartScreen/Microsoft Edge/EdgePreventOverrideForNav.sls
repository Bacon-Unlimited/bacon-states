...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Windows Defender SmartScreen\Microsoft Edge\EdgePreventOverrideForNav.sls
#
# SUPPORTED WINDOWS OS
# edge:SUPPORTED_INTERNET_BROWSER_WIN10V1511
#
...
Prevent bypassing Windows Defender SmartScreen prompts for sites:
  lgpo.set:
  - name: EdgePreventOverrideForNav
  - setting: Enabled
