...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Intranet Zone\IZ_PolicyTurnOnXSSFilter_Both_IntranetLockdown.sls
#
...
Turn on Cross-Site Scripting Filter:
  lgpo.set:
  - name: IZ_PolicyTurnOnXSSFilter_Both_IntranetLockdown
  - setting:
