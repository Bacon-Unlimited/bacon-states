...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Intranet Zone\IZ_PolicySoftwareChannelPermissions_4.sls
#
...
Software channel permissions:
  lgpo.set:
  - name: IZ_PolicySoftwareChannelPermissions_4
  - setting:
