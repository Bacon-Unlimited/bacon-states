...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Intranet Zone\IZ_Policy_TurnOnProtectedMode_4.sls
#
...
Turn on Protected Mode:
  lgpo.set:
  - name: IZ_Policy_TurnOnProtectedMode_4
  - setting:
