...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Intranet Zone\IZ_PolicyBlockPopupWindows_4.sls
#
...
Use Pop-up Blocker:
  lgpo.set:
  - name: IZ_PolicyBlockPopupWindows_4
  - setting:
