...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Intranet Zone\IZ_Policy_AddressStatusBar_4.sls
#
...
Allow websites to open windows without status bar or Address bar:
  lgpo.set:
  - name: IZ_Policy_AddressStatusBar_4
  - setting:
