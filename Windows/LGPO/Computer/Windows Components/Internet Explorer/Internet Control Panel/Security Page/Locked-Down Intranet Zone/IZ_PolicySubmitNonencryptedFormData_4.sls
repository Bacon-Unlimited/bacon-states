...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Intranet Zone\IZ_PolicySubmitNonencryptedFormData_4.sls
#
...
Submit non-encrypted form data:
  lgpo.set:
  - name: IZ_PolicySubmitNonencryptedFormData_4
  - setting:
