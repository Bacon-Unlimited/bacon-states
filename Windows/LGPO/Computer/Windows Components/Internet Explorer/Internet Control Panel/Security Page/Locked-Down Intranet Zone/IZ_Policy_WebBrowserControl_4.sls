...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Intranet Zone\IZ_Policy_WebBrowserControl_4.sls
#
...
Allow scripting of Internet Explorer WebBrowser controls:
  lgpo.set:
  - name: IZ_Policy_WebBrowserControl_4
  - setting:
