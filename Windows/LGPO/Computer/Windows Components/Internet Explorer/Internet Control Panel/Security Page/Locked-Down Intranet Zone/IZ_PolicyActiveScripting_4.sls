...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Intranet Zone\IZ_PolicyActiveScripting_4.sls
#
...
Allow active scripting:
  lgpo.set:
  - name: IZ_PolicyActiveScripting_4
  - setting:
