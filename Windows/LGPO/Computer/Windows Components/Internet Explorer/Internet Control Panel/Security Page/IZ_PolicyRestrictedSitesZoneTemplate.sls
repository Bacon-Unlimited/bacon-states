...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\IZ_PolicyRestrictedSitesZoneTemplate.sls
#
...
Restricted Sites Zone Template:
  ...
  - setting:
      IZ_PartnameRestrictedSitesZoneTemplate: enum-placeholder
