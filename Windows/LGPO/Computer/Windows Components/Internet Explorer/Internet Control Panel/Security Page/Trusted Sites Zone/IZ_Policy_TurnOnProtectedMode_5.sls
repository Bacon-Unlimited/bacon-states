...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Trusted Sites Zone\IZ_Policy_TurnOnProtectedMode_5.sls
#
...
Turn on Protected Mode:
  lgpo.set:
  - name: IZ_Policy_TurnOnProtectedMode_5
  - setting:
