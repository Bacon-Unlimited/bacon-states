...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Trusted Sites Zone\IZ_PolicySignedFrameworkComponentsURLaction_5.sls
#
...
Run .NET Framework-reliant components signed with Authenticode:
  lgpo.set:
  - name: IZ_PolicySignedFrameworkComponentsURLaction_5
  - setting:
