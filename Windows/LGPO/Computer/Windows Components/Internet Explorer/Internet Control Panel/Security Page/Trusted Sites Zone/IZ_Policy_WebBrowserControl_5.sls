...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Trusted Sites Zone\IZ_Policy_WebBrowserControl_5.sls
#
...
Allow scripting of Internet Explorer WebBrowser controls:
  lgpo.set:
  - name: IZ_Policy_WebBrowserControl_5
  - setting:
