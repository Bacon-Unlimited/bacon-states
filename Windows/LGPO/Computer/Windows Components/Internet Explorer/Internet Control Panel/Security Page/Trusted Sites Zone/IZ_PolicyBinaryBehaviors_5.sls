...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Trusted Sites Zone\IZ_PolicyBinaryBehaviors_5.sls
#
...
Allow binary and script behaviors:
  lgpo.set:
  - name: IZ_PolicyBinaryBehaviors_5
  - setting:
