...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Trusted Sites Zone\IZ_Policy_FirstRunOptIn_5.sls
#
...
Turn off first-run prompt:
  lgpo.set:
  - name: IZ_Policy_FirstRunOptIn_5
  - setting:
