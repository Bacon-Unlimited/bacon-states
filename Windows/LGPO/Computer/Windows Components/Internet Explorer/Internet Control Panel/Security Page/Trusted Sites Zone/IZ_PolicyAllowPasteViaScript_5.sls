...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Trusted Sites Zone\IZ_PolicyAllowPasteViaScript_5.sls
#
...
Allow cut, copy or paste operations from the clipboard via script:
  lgpo.set:
  - name: IZ_PolicyAllowPasteViaScript_5
  - setting:
