...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Trusted Sites Zone\IZ_PolicyDownloadUnsignedActiveX_5.sls
#
...
# 
# If you do not configure this policy setting, users are queried to choose whether to allow the unsigned control to run.
Download unsigned ActiveX controls:
  lgpo.set:
  - name: IZ_PolicyDownloadUnsignedActiveX_5
  - setting:
