...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Local Machine Zone\IZ_PolicyAllowVBScript_10.sls
#
...
# 
# If you do not configure or disable this policy setting, users are asked to choose whether to allow VBScript to run.
Allow VBScript to run in Internet Explorer:
  lgpo.set:
  - name: IZ_PolicyAllowVBScript_10
  - setting:
