...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Local Machine Zone\IZ_Policy_ScriptStatusBar_10.sls
#
...
Allow updates to status bar via script:
  lgpo.set:
  - name: IZ_Policy_ScriptStatusBar_10
  - setting:
