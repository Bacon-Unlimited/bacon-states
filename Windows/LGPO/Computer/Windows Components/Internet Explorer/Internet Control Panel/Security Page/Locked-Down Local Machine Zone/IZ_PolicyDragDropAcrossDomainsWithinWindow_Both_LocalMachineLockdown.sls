...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Local Machine Zone\IZ_PolicyDragDropAcrossDomainsWithinWindow_Both_LocalMachineLockdown.sls
#
...
Enable dragging of content from different domains within a window:
  lgpo.set:
  - name: IZ_PolicyDragDropAcrossDomainsWithinWindow_Both_LocalMachineLockdown
  - setting:
