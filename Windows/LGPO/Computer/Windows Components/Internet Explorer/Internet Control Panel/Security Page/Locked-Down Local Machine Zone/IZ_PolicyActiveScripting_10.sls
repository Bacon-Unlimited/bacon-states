...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Local Machine Zone\IZ_PolicyActiveScripting_10.sls
#
...
# 
# If you do not configure this policy setting, users are queried to choose whether to allow script code on pages in the Local Machine zone to run.
Allow active scripting:
  lgpo.set:
  - name: IZ_PolicyActiveScripting_10
  - setting:
