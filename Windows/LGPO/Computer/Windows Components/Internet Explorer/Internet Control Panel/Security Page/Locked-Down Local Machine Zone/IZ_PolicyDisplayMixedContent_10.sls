...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Local Machine Zone\IZ_PolicyDisplayMixedContent_10.sls
#
...
Display mixed content:
  lgpo.set:
  - name: IZ_PolicyDisplayMixedContent_10
  - setting:
