...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Local Machine Zone\IZ_PolicySoftwareChannelPermissions_10.sls
#
...
Software channel permissions:
  lgpo.set:
  - name: IZ_PolicySoftwareChannelPermissions_10
  - setting:
