...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Local Machine Zone\IZ_PolicyDropOrPasteFiles_10.sls
#
...
Allow drag and drop or copy and paste files:
  lgpo.set:
  - name: IZ_PolicyDropOrPasteFiles_10
  - setting:
