...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Local Machine Zone\IZ_PolicyDownloadSignedActiveX_10.sls
#
...
# 
# If you do not configure this policy setting, users can download signed controls without user intervention.
Download signed ActiveX controls:
  lgpo.set:
  - name: IZ_PolicyDownloadSignedActiveX_10
  - setting:
