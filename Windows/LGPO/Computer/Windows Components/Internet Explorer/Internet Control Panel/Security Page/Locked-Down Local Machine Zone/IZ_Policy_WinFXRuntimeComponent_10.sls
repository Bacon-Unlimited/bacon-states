...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Local Machine Zone\IZ_Policy_WinFXRuntimeComponent_10.sls
#
...
Turn off .NET Framework Setup:
  lgpo.set:
  - name: IZ_Policy_WinFXRuntimeComponent_10
  - setting:
