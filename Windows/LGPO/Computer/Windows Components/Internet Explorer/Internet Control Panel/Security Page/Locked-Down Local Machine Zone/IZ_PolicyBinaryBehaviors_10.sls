...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Local Machine Zone\IZ_PolicyBinaryBehaviors_10.sls
#
...
# 
# If you do not configure this policy setting, only behaviors listed in the Admin-approved Behaviors under Binary Behaviors Security Restriction policy are available.
Allow binary and script behaviors:
  lgpo.set:
  - name: IZ_PolicyBinaryBehaviors_10
  - setting:
