...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Local Machine Zone\IZ_PolicyWindowsRestrictionsURLaction_10.sls
#
...
Allow script-initiated windows without size or position constraints:
  lgpo.set:
  - name: IZ_PolicyWindowsRestrictionsURLaction_10
  - setting:
