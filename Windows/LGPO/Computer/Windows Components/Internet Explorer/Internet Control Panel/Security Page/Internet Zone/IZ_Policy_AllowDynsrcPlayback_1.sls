...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Internet Zone\IZ_Policy_AllowDynsrcPlayback_1.sls
#
...
Allow video and animation on a webpage that uses an older media player:
  lgpo.set:
  - name: IZ_Policy_AllowDynsrcPlayback_1
  - setting:
