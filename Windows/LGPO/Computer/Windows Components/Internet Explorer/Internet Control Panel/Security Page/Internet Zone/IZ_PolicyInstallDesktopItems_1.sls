...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Internet Zone\IZ_PolicyInstallDesktopItems_1.sls
#
...
Allow installation of desktop items:
  lgpo.set:
  - name: IZ_PolicyInstallDesktopItems_1
  - setting:
