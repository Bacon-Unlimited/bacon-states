...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Internet Zone\IZ_PolicyAllowMETAREFRESH_1.sls
#
...
Allow META REFRESH:
  lgpo.set:
  - name: IZ_PolicyAllowMETAREFRESH_1
  - setting:
