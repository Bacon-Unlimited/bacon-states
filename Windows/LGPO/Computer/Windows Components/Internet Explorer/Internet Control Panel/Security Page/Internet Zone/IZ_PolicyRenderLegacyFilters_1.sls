...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Internet Zone\IZ_PolicyRenderLegacyFilters_1.sls
#
...
Render legacy filters:
  lgpo.set:
  - name: IZ_PolicyRenderLegacyFilters_1
  - setting:
