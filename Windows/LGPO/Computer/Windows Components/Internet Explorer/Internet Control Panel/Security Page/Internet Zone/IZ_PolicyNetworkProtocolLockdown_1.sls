...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Internet Zone\IZ_PolicyNetworkProtocolLockdown_1.sls
#
...
Allow active content over restricted protocols to access my computer:
  lgpo.set:
  - name: IZ_PolicyNetworkProtocolLockdown_1
  - setting:
