...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Internet Zone\IZ_PolicySoftwareChannelPermissions_1.sls
#
...
Software channel permissions:
  lgpo.set:
  - name: IZ_PolicySoftwareChannelPermissions_1
  - setting:
