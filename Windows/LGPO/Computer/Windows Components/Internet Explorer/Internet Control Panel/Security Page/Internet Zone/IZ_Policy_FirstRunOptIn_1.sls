...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Internet Zone\IZ_Policy_FirstRunOptIn_1.sls
#
...
Turn off first-run prompt:
  lgpo.set:
  - name: IZ_Policy_FirstRunOptIn_1
  - setting:
