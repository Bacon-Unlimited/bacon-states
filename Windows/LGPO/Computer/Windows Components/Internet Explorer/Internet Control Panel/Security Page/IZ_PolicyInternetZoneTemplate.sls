...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\IZ_PolicyInternetZoneTemplate.sls
#
...
Internet Zone Template:
  ...
  - setting:
      IZ_PartnameInternetZoneTemplate: enum-placeholder
