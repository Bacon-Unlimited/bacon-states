...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_PolicyRunActiveXControls_3.sls
#
...
Run ActiveX controls and plugins:
  lgpo.set:
  - name: IZ_PolicyRunActiveXControls_3
  - setting:
