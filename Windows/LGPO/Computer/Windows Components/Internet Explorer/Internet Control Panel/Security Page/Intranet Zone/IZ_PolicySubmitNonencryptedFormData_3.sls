...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_PolicySubmitNonencryptedFormData_3.sls
#
...
Submit non-encrypted form data:
  lgpo.set:
  - name: IZ_PolicySubmitNonencryptedFormData_3
  - setting:
