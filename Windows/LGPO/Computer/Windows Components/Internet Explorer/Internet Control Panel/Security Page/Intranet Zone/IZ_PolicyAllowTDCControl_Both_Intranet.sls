...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_PolicyAllowTDCControl_Both_Intranet.sls
#
...
Allow only approved domains to use the TDC ActiveX control:
  lgpo.set:
  - name: IZ_PolicyAllowTDCControl_Both_Intranet
  - setting:
