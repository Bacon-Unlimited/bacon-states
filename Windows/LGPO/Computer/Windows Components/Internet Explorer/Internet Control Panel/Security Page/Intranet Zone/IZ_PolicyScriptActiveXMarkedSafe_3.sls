...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_PolicyScriptActiveXMarkedSafe_3.sls
#
...
Script ActiveX controls marked safe for scripting:
  lgpo.set:
  - name: IZ_PolicyScriptActiveXMarkedSafe_3
  - setting:
