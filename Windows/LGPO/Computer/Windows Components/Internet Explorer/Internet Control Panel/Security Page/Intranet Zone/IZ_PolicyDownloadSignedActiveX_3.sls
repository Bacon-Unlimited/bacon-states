...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_PolicyDownloadSignedActiveX_3.sls
#
...
Download signed ActiveX controls:
  lgpo.set:
  - name: IZ_PolicyDownloadSignedActiveX_3
  - setting:
