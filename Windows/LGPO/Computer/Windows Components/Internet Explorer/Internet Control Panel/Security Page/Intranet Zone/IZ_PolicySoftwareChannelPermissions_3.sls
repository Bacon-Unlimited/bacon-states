...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_PolicySoftwareChannelPermissions_3.sls
#
...
# 
# If you do not configure this policy setting, permissions are set to Medium safety.
Software channel permissions:
  lgpo.set:
  - name: IZ_PolicySoftwareChannelPermissions_3
  - setting:
