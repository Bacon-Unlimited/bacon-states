...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_Policy_LocalPathForUpload_3.sls
#
...
Include local path when user is uploading files to a server:
  lgpo.set:
  - name: IZ_Policy_LocalPathForUpload_3
  - setting:
