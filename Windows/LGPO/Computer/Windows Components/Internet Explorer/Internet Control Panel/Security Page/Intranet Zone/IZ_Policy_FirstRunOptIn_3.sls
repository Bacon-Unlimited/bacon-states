...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_Policy_FirstRunOptIn_3.sls
#
...
Turn off first-run prompt:
  lgpo.set:
  - name: IZ_Policy_FirstRunOptIn_3
  - setting:
