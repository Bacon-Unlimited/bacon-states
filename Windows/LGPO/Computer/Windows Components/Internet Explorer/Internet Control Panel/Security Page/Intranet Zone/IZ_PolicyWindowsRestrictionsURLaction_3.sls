...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_PolicyWindowsRestrictionsURLaction_3.sls
#
...
Allow script-initiated windows without size or position constraints:
  lgpo.set:
  - name: IZ_PolicyWindowsRestrictionsURLaction_3
  - setting:
