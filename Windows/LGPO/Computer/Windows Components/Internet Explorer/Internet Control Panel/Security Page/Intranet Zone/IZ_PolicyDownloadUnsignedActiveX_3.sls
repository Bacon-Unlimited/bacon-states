...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_PolicyDownloadUnsignedActiveX_3.sls
#
...
Download unsigned ActiveX controls:
  lgpo.set:
  - name: IZ_PolicyDownloadUnsignedActiveX_3
  - setting:
