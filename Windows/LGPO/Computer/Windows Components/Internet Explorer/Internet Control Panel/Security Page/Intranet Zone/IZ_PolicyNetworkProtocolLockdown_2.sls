...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_PolicyNetworkProtocolLockdown_2.sls
#
...
Allow active content over restricted protocols to access my computer:
  lgpo.set:
  - name: IZ_PolicyNetworkProtocolLockdown_2
  - setting:
