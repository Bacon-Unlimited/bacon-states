...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Intranet Zone\IZ_PolicyActiveScripting_3.sls
#
...
Allow active scripting:
  lgpo.set:
  - name: IZ_PolicyActiveScripting_3
  - setting:
