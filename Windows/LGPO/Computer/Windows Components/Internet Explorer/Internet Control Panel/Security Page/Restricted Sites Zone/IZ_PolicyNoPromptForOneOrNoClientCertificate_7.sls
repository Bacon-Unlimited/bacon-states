...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Restricted Sites Zone\IZ_PolicyNoPromptForOneOrNoClientCertificate_7.sls
#
...
Do not prompt for client certificate selection when no certificates or only one certificate exists.:
  lgpo.set:
  - name: IZ_PolicyNoPromptForOneOrNoClientCertificate_7
  - setting:
