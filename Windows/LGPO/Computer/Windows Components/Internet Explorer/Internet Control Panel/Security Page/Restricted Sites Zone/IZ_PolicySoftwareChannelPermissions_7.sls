...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Restricted Sites Zone\IZ_PolicySoftwareChannelPermissions_7.sls
#
...
# 
# If you do not configure this policy setting, permissions are set to High safety.
Software channel permissions:
  lgpo.set:
  - name: IZ_PolicySoftwareChannelPermissions_7
  - setting:
