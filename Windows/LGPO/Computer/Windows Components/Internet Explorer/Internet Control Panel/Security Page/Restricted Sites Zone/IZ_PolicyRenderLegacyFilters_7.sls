...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Restricted Sites Zone\IZ_PolicyRenderLegacyFilters_7.sls
#
...
Render legacy filters:
  lgpo.set:
  - name: IZ_PolicyRenderLegacyFilters_7
  - setting:
