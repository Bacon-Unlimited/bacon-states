...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Restricted Sites Zone\IZ_PolicyNetworkProtocolLockdown_4.sls
#
...
# 
# If you do not configure this policy setting, all attempts to access such content over the restricted protocols is blocked when the Network Protocol Lockdown security feature is enabled.
Allow active content over restricted protocols to access my computer:
  lgpo.set:
  - name: IZ_PolicyNetworkProtocolLockdown_4
  - setting:
