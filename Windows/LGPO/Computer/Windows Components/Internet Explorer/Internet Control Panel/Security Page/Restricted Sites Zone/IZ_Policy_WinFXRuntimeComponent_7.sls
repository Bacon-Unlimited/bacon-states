...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Restricted Sites Zone\IZ_Policy_WinFXRuntimeComponent_7.sls
#
...
Turn off .NET Framework Setup:
  lgpo.set:
  - name: IZ_Policy_WinFXRuntimeComponent_7
  - setting:
