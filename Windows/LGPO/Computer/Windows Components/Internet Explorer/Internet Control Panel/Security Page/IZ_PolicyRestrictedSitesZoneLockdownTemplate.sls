...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\IZ_PolicyRestrictedSitesZoneLockdownTemplate.sls
#
...
Locked-Down Restricted Sites Zone Template:
  ...
  - setting:
      IZ_PartnameRestrictedSitesZoneLockdownTemplate: enum-placeholder
