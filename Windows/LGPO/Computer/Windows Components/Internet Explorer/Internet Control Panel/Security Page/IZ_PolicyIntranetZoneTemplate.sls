...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\IZ_PolicyIntranetZoneTemplate.sls
#
...
Intranet Zone Template:
  ...
  - setting:
      IZ_PartnameIntranetZoneTemplate: enum-placeholder
