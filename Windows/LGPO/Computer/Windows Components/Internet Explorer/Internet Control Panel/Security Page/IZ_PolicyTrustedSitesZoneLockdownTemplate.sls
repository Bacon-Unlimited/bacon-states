...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\IZ_PolicyTrustedSitesZoneLockdownTemplate.sls
#
...
Locked-Down Trusted Sites Zone Template:
  ...
  - setting:
      IZ_PartnameTrustedSitesZoneLockdownTemplate: enum-placeholder
