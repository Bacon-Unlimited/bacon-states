...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_PolicySoftwareChannelPermissions_2.sls
#
...
Software channel permissions:
  lgpo.set:
  - name: IZ_PolicySoftwareChannelPermissions_2
  - setting:
