...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_Policy_FirstRunOptIn_2.sls
#
...
Turn off first-run prompt:
  lgpo.set:
  - name: IZ_Policy_FirstRunOptIn_2
  - setting:
