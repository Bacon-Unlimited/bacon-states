...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_PolicyNoPromptForOneOrNoClientCertificate_2.sls
#
...
Do not prompt for client certificate selection when no certificates or only one certificate exists.:
  lgpo.set:
  - name: IZ_PolicyNoPromptForOneOrNoClientCertificate_2
  - setting:
