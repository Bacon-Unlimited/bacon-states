...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_PolicySignedFrameworkComponentsURLaction_2.sls
#
...
Run .NET Framework-reliant components signed with Authenticode:
  lgpo.set:
  - name: IZ_PolicySignedFrameworkComponentsURLaction_2
  - setting:
