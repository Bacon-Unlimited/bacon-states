...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_PolicyAllowTDCControl_Both_InternetLockdown.sls
#
...
Allow only approved domains to use the TDC ActiveX control:
  lgpo.set:
  - name: IZ_PolicyAllowTDCControl_Both_InternetLockdown
  - setting:
