...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_PolicyActiveScripting_2.sls
#
...
Allow active scripting:
  lgpo.set:
  - name: IZ_PolicyActiveScripting_2
  - setting:
