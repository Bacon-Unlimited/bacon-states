...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_Policy_ScriptStatusBar_2.sls
#
...
Allow updates to status bar via script:
  lgpo.set:
  - name: IZ_Policy_ScriptStatusBar_2
  - setting:
