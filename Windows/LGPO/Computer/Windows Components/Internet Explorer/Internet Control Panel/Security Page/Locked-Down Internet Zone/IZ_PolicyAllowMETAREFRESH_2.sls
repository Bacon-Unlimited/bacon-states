...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_PolicyAllowMETAREFRESH_2.sls
#
...
Allow META REFRESH:
  lgpo.set:
  - name: IZ_PolicyAllowMETAREFRESH_2
  - setting:
