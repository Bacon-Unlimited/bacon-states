...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_PolicyMimeSniffingURLaction_2.sls
#
...
Enable MIME Sniffing:
  lgpo.set:
  - name: IZ_PolicyMimeSniffingURLaction_2
  - setting:
