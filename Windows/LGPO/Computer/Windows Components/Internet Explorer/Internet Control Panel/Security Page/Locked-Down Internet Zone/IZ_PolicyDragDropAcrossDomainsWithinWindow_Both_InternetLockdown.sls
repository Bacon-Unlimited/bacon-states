...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_PolicyDragDropAcrossDomainsWithinWindow_Both_InternetLockdown.sls
#
...
Enable dragging of content from different domains within a window:
  lgpo.set:
  - name: IZ_PolicyDragDropAcrossDomainsWithinWindow_Both_InternetLockdown
  - setting:
