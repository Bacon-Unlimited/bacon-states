...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_PolicyRunActiveXControls_2.sls
#
...
Run ActiveX controls and plugins:
  lgpo.set:
  - name: IZ_PolicyRunActiveXControls_2
  - setting:
