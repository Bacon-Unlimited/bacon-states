...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Internet Zone\IZ_PolicyInstallDesktopItems_2.sls
#
...
# 
# If you do not configure this policy setting, users are queried to choose whether to install desktop items from this zone.
Allow installation of desktop items:
  lgpo.set:
  - name: IZ_PolicyInstallDesktopItems_2
  - setting:
