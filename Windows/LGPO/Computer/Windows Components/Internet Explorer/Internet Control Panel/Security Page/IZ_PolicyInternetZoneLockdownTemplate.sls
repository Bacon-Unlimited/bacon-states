...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\IZ_PolicyInternetZoneLockdownTemplate.sls
#
...
Locked-Down Internet Zone Template:
  ...
  - setting:
      IZ_PartnameInternetZoneLockdownTemplate: enum-placeholder
