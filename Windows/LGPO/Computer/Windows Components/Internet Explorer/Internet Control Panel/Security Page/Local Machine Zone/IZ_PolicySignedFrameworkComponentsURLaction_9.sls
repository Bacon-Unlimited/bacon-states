...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Local Machine Zone\IZ_PolicySignedFrameworkComponentsURLaction_9.sls
#
...
Run .NET Framework-reliant components signed with Authenticode:
  lgpo.set:
  - name: IZ_PolicySignedFrameworkComponentsURLaction_9
  - setting:
