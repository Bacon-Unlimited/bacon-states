...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Local Machine Zone\IZ_PolicyRunActiveXControls_9.sls
#
...
# 
# If you do not configure this policy setting, controls and plug-ins can run without user intervention.
Run ActiveX controls and plugins:
  lgpo.set:
  - name: IZ_PolicyRunActiveXControls_9
  - setting:
