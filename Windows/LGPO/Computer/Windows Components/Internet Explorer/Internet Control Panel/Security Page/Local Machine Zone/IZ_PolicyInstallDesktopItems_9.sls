...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Local Machine Zone\IZ_PolicyInstallDesktopItems_9.sls
#
...
Allow installation of desktop items:
  lgpo.set:
  - name: IZ_PolicyInstallDesktopItems_9
  - setting:
