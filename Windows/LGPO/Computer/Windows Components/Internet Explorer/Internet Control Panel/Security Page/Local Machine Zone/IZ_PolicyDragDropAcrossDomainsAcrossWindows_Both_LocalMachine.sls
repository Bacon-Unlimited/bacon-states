...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Local Machine Zone\IZ_PolicyDragDropAcrossDomainsAcrossWindows_Both_LocalMachine.sls
#
...
Enable dragging of content from different domains across windows:
  lgpo.set:
  - name: IZ_PolicyDragDropAcrossDomainsAcrossWindows_Both_LocalMachine
  - setting:
