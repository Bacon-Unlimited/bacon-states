...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Local Machine Zone\IZ_PolicyOnlyAllowApprovedDomainsToUseActiveXWithoutPrompt_Both_LocalMachine.sls
#
...
Allow only approved domains to use ActiveX controls without prompt:
  lgpo.set:
  - name: IZ_PolicyOnlyAllowApprovedDomainsToUseActiveXWithoutPrompt_Both_LocalMachine
  - setting:
