...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Local Machine Zone\IZ_Policy_WebBrowserApps_9.sls
#
...
Allow loading of XAML Browser Applications:
  lgpo.set:
  - name: IZ_Policy_WebBrowserApps_9
  - setting:
