...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Local Machine Zone\IZ_PolicyTurnOnXSSFilter_Both_LocalMachine.sls
#
...
Turn on Cross-Site Scripting Filter:
  lgpo.set:
  - name: IZ_PolicyTurnOnXSSFilter_Both_LocalMachine
  - setting:
