...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Local Machine Zone\IZ_PolicyRenderLegacyFilters_9.sls
#
...
Render legacy filters:
  lgpo.set:
  - name: IZ_PolicyRenderLegacyFilters_9
  - setting:
