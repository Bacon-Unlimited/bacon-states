...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Local Machine Zone\IZ_PolicyDownloadUnsignedActiveX_9.sls
#
...
# 
# If you do not configure this policy setting, users can run unsigned controls without user intervention.
Download unsigned ActiveX controls:
  lgpo.set:
  - name: IZ_PolicyDownloadUnsignedActiveX_9
  - setting:
