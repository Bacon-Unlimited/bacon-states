...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Local Machine Zone\IZ_PolicyScriptActiveXMarkedSafe_9.sls
#
...
Script ActiveX controls marked safe for scripting:
  lgpo.set:
  - name: IZ_PolicyScriptActiveXMarkedSafe_9
  - setting:
