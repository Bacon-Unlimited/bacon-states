...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\IZ_PolicyLocalMachineZoneTemplate.sls
#
...
Local Machine Zone Template:
  ...
  - setting:
      IZ_PartnameLocalMachineZoneTemplate: enum-placeholder
