...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Restricted Sites Zone\IZ_PolicyDisplayMixedContent_8.sls
#
...
Display mixed content:
  lgpo.set:
  - name: IZ_PolicyDisplayMixedContent_8
  - setting:
