...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Restricted Sites Zone\IZ_Policy_WebBrowserApps_8.sls
#
...
Allow loading of XAML Browser Applications:
  lgpo.set:
  - name: IZ_Policy_WebBrowserApps_8
  - setting:
