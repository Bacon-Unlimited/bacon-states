...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Restricted Sites Zone\IZ_PolicyScriptActiveXMarkedSafe_8.sls
#
...
Script ActiveX controls marked safe for scripting:
  lgpo.set:
  - name: IZ_PolicyScriptActiveXMarkedSafe_8
  - setting:
