...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Restricted Sites Zone\IZ_PolicyMimeSniffingURLaction_8.sls
#
...
Enable MIME Sniffing:
  lgpo.set:
  - name: IZ_PolicyMimeSniffingURLaction_8
  - setting:
