...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Restricted Sites Zone\IZ_PolicyLaunchAppsAndFilesInIFRAME_8.sls
#
...
Launching applications and files in an IFRAME:
  lgpo.set:
  - name: IZ_PolicyLaunchAppsAndFilesInIFRAME_8
  - setting:
