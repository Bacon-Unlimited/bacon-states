...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Restricted Sites Zone\IZ_PolicyActiveScripting_8.sls
#
...
Allow active scripting:
  lgpo.set:
  - name: IZ_PolicyActiveScripting_8
  - setting:
