...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\IZ_PolicyIntranetZoneLockdownTemplate.sls
#
...
Locked-Down Intranet Zone Template:
  ...
  - setting:
      IZ_PartnameIntranetZoneLockdownTemplate: enum-placeholder
