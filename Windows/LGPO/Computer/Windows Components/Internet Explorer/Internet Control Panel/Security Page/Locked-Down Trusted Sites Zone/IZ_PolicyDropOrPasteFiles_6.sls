...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Trusted Sites Zone\IZ_PolicyDropOrPasteFiles_6.sls
#
...
Allow drag and drop or copy and paste files:
  lgpo.set:
  - name: IZ_PolicyDropOrPasteFiles_6
  - setting:
