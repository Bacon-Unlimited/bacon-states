...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Trusted Sites Zone\IZ_PolicyBlockPopupWindows_6.sls
#
...
Use Pop-up Blocker:
  lgpo.set:
  - name: IZ_PolicyBlockPopupWindows_6
  - setting:
