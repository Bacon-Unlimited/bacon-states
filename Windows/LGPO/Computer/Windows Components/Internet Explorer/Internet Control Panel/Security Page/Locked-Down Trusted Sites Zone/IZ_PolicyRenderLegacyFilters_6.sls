...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Trusted Sites Zone\IZ_PolicyRenderLegacyFilters_6.sls
#
...
Render legacy filters:
  lgpo.set:
  - name: IZ_PolicyRenderLegacyFilters_6
  - setting:
