...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Trusted Sites Zone\IZ_PolicyActiveScripting_6.sls
#
...
Allow active scripting:
  lgpo.set:
  - name: IZ_PolicyActiveScripting_6
  - setting:
