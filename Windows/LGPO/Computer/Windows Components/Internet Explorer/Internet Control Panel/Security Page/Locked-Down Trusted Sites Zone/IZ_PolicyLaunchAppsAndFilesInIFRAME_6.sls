...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Trusted Sites Zone\IZ_PolicyLaunchAppsAndFilesInIFRAME_6.sls
#
...
Launching applications and files in an IFRAME:
  lgpo.set:
  - name: IZ_PolicyLaunchAppsAndFilesInIFRAME_6
  - setting:
