...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Trusted Sites Zone\IZ_PolicyDragDropAcrossDomainsAcrossWindows_Both_TrustedLockdown.sls
#
...
Enable dragging of content from different domains across windows:
  lgpo.set:
  - name: IZ_PolicyDragDropAcrossDomainsAcrossWindows_Both_TrustedLockdown
  - setting:
