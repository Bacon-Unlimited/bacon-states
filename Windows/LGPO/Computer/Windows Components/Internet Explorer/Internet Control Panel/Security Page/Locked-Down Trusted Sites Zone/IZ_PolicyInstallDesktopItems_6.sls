...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Trusted Sites Zone\IZ_PolicyInstallDesktopItems_6.sls
#
...
Allow installation of desktop items:
  lgpo.set:
  - name: IZ_PolicyInstallDesktopItems_6
  - setting:
