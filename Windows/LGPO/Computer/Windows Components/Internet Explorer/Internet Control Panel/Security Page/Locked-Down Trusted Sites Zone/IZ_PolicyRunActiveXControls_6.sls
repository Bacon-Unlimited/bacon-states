...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Trusted Sites Zone\IZ_PolicyRunActiveXControls_6.sls
#
...
Run ActiveX controls and plugins:
  lgpo.set:
  - name: IZ_PolicyRunActiveXControls_6
  - setting:
