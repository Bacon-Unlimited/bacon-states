...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Trusted Sites Zone\IZ_PolicySoftwareChannelPermissions_6.sls
#
...
Software channel permissions:
  lgpo.set:
  - name: IZ_PolicySoftwareChannelPermissions_6
  - setting:
