...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Internet Control Panel\Security Page\Locked-Down Trusted Sites Zone\IZ_Policy_WebBrowserApps_6.sls
#
...
Allow loading of XAML Browser Applications:
  lgpo.set:
  - name: IZ_Policy_WebBrowserApps_6
  - setting:
