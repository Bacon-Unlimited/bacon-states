...
#
####### LGPO DETAILS ########
# LOCATION: \Computer\Windows Components\Internet Explorer\Security Features\Restrict ActiveX Install\IESF_PolicyProcessList_11.sls
#
...
Process List:
  lgpo.set:
  - name: IESF_PolicyProcessList_11
  - setting:
